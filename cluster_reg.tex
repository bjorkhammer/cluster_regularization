...
and rotational invariance nicely build in by construction. The Behler-Parrinello (BP)
...
have been developed for which e.g.\ 4-atom torsion angles are included.
...
\subsection{Cluster regularization method}

\begin{figure}[tb]
    \centering
    \includegraphics[width=1.0\columnwidth]{schematic.png}
    \caption{}
    \label{fig_schem}
\end{figure}
...
schematically in Fig.\ \ref{fig_schem}. In the following, we demonstrate the usefulness of
...
atomic features present in the latest structure in the search.  Figures
...
combined method still exhibit a much sooner onset of the finding of the global energy
...
global minimum energy structure, with the (1$\times$4) ridge
...
evolutionary algorithm, that has a bias forwards taking structures
...
techniques. The usefulness of the mutation method was demonstrated in
