\documentclass[journal=jpccck,layout=twocolumn,manuscript=letter]{achemso}
...
performed for TiO$_2$ structures using parameters from ref \cite{Dolgonos2010}.
With this description, bulk anatase TiO$_2$ has lattice parameters of
$a=3.94$ {\AA} and $c=9.47$ {\AA}. DFTB calculations for TiO$_2$ systems have previously been conducted
successfully in studies where either the system size or the number of calculations is too large for a full first principles density functional theory (DFT) study \cite{Selli2017a, Selli2017b}. The loss of accuracy in using DFTB over DFT in this study is not of significant importance because our goal is to enhance global structure optimization, and not that of finding exact geometries. In the present work, we
