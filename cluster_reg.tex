...
reconstructions and ad-structures,\cite{rutile1,rutile2,anatase1} that have no equivalent in any TiO$_2$ bulk or surface systems.
...
frameworks. Among these, stoichastic methods such as random search\cite{XX} and
basin hopping (BH)\cite{XX} are widely used and more advanced methods based on
evolutionary algorithms (EA) are becoming increasingly popular.\cite{XX} Common
...
systems are combined.\cite{XX} The exploration of configuration space is
...
also test the method in a basin hopping (BH) framework,\cite{XX} in which some
...
systems include the bag-of-bonds\cite{XX} and fingerprint\cite{XX} feature
...
sophisticated methods such as the Coulomb matrix\cite{XX} have been
proposed.
...
symmetry function formulation\cite{XX} stand out as a seminal
...
diverse set of molecules.\cite{XX}
...
functions of Behler \textit{et al.}\cite{XX}. For a discussion on this see the work of Botu
...
\bibitem{si7x7}K.\ Takayanagi, Y.\ Tanishiro, S.\ Takahashi, and M.\ Takahashi, Surf.\ Sci.\ \textfbf{164}, 367 (1985).
\bibitem{si4x2}
\bibitem{rutile1}
\bibitem{rutile2}
\bibitem{anatase1}
...
\bibitem{Chen2017} {Understanding atomic chemistry with machine learning.} Chen, X., Jørgensen, M. S., Hammer, B., \& Li, J. (2017) Unpublished
