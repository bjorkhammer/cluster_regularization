...
schematically in Figure \ref{fig_schem}. In the following, we demonstrate the usefulness of
...
same two local minima, one in the cluster distance landscape and one
in the energy landscape. However, occasionally, the BH runs succeed in
