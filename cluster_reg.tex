...
atomic features present in the latest structure in the search.  Figure
...
compares to an BHO. based result of 59\% cut\&splice and
...
structure sooner than the benchmark method (yellow curve). For the two-layer system,
