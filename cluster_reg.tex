...
composition, crystaline polymorph, and surface orientation. Dangling
...
the computational setup and outline the reference method used. In the
Theory section we describe the components of our method, including the
choice of feature vector and the clustering technique. In the Results and Discussion
...
position is increased in the global optimization. The paper ends with a Conclusion section.
